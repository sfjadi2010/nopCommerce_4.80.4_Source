...
$(document).ready(function() {
    ...
    var originalPreprocessAjaxData = $.fn.dataTable.ext.legacy !== undefined ? 
        $.fn.dataTable.ext.legacy.ajax : null;
    ...
    $.fn.dataTable.ext.legacy.ajax = function(settings, data) {
        ...
        if (data.order && data.order.length > 0) {
            ...
            console.log('DataTables 1.10+ format - Order_0__Column=' + data.Order_0__Column + ', Order_0__Dir=' + data.Order_0__Dir);
        } 
        // Handle DataTables 1.9- format (iSortCol_0 and sSortDir_0)
            ...
            console.log('DataTables 1.9- format - Order_0__Column=' + data.Order_0__Column + ', Order_0__Dir=' + data.Order_0__Dir);
        }
        // Handle settings-based sorting (aaSorting)
            ...
            console.log('Settings-based format - Order_0__Column=' + data.Order_0__Column + ', Order_0__Dir=' + data.Order_0__Dir);
        }
    };
        ...
        if (table) {
            setTimeout(function() {
                ...
                if (order && order.length) {
                    console.log('Column clicked - New sort order: Column ' + order[0][0] + ' - Direction: ' + order[0][1]);
                }
            }, 100);
        }
    });
